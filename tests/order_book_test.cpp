...
TEST_CASE("addOrder - buy order rests in bids", "[orderbook][add]") {
  ...
  book.addOrder(OrderType::GOOD_TILL_CANCEL, order);
...
TEST_CASE("addOrder - multiple buys at same price aggregate", "[orderbook][add]") {
  ...
  book.addOrder(OrderType::GOOD_TILL_CANCEL, order1);
  book.addOrder(OrderType::GOOD_TILL_CANCEL, order2);
...
TEST_CASE("addOrder - buy and sell go to separate sides", "[orderbook][add]") {
  ...
  book.addOrder(OrderType::GOOD_TILL_CANCEL, buy);
  book.addOrder(OrderType::GOOD_TILL_CANCEL, sell);
...
TEST_CASE("matching - buy price below ask, no match", "[orderbook][matching]") {
  OrderBook book;
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(1, Side::SELL, 102, 50, 1));
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(2, Side::BUY, 100, 50, 2));
...
TEST_CASE("matching - sell fully fills resting buy", "[orderbook][matching]") {
  OrderBook book;
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(1, Side::BUY, 100, 50, 1));
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(2, Side::SELL, 100, 50, 2));
...
TEST_CASE("matching - sell partially fills resting buy, remainder rests", "[orderbook][matching]") {
  OrderBook book;
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(1, Side::BUY, 100, 30, 1));
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(2, Side::SELL, 100, 50, 2));
...
TEST_CASE("matching - sell sweeps multiple bid levels", "[orderbook][matching]") {
  OrderBook book;
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(1, Side::BUY, 101, 20, 1));
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(2, Side::BUY, 100, 20, 2));
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(3, Side::SELL, 100, 50, 3));
...
TEST_CASE("stp - buy hits own resting sell, returns STP_CANCELLED", "[orderbook][stp]") {
  OrderBook book;
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(1, Side::SELL, 100, 50, 1));
  AddResult result = book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(2, Side::BUY, 100, 50, 1));
...
TEST_CASE("stp - sell hits own resting buy, returns STP_CANCELLED", "[orderbook][stp]") {
  OrderBook book;
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(1, Side::BUY, 100, 50, 1));
  AddResult result = book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(2, Side::SELL, 100, 50, 1));
...
TEST_CASE("stp - different users match normally", "[orderbook][stp]") {
  OrderBook book;
  book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(1, Side::SELL, 100, 50, 1));
  AddResult result = book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(2, Side::BUY, 100, 50, 2));
...
TEST_CASE("stp - partial fill before own order, remainder cancelled", "[orderbook][stp]") {
  ...
  AddResult result = book.addOrder(OrderType::GOOD_TILL_CANCEL, Order(3, Side::BUY, 100, 50, 1));
